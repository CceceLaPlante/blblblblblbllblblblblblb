...
def _minimax(state, maximizing_player_id, row, col, alpha, beta,init_state):
    ...
    if player == maximizing_player_id :
        ...
        for action in state.legal_actions() :
            ...
            ic = in_cache(sc,seen_sc,init_state)
            if ic is not None:
                val = ic
            else :
                val = _minimax(sc, maximizing_player_id, row, col, alpha, beta,init_state)
                seen_sc[get_key(sc,init_state)] = val
...
def minimax_search ( game, 
    ...
    return _minimax(state, maximizing_player_id, row, col, alpha, beta,init_state)
